...
function decisionToDerived(decision: ConnectorActionDecision): DerivedCapability {
  return {
    ...
    toolMappingStatus: decision.toolMappingStatus,
    toolMappingProof: decision.toolMappingProof ? { ...decision.toolMappingProof } : undefined,
    provider: decision.provider,
    resourceSystem: decision.resourceSystem,
    requiredApplicationGrants: decision.requiredApplicationGrants ? [...decision.requiredApplicationGrants] : undefined,
    requiredEffectivePermissions: decision.requiredEffectivePermissions ? [...decision.requiredEffectivePermissions] : undefined,
    requestedScopes: decision.requestedScopes ? [...decision.requestedScopes] : undefined,
