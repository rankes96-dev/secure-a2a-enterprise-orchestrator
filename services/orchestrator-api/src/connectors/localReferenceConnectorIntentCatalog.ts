...
export const localReferenceConnectorIntentCatalog: ConnectorIntentHint[] = [
  ...
  },
  {
    ...
    systemTerms: ["servicenow", "service now", "incident", "catalog item", "service catalog", "catalog recommendation", "requested item", "request status", "status of my request", "service request status", "ritm", "change request", "inc", "ticket", "aws", "mailing list", "תפוצה", "הרשאה"],
    skillHints: [
      {
        skillId: "servicenow.ticket.status.lookup",
        label: "Look up ServiceNow ticket status",
        includeAny: ["status of my ticket", "request status", "status of my request", "requested item status", "ritm status", "service request status", "ticket", "inc", "ritm", "סטטוס"],
      ...
      },
      {
        ...
        includeAny: ["catalog recommendation", "service catalog", "catalog recommend", "aws production access", "permission to aws", "need aws", "הרשאה ל-aws", "הרשאה ל aws", "mailing list", "create a mailing list", "תפוצה", "shared mailbox", "mailbox"],
