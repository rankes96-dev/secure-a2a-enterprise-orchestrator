...
export function decideConnectorActions(input: ConnectorDecisionInput): ConnectorActionDecision[] {
  ...
  return declaredSkills.map((actionId) => {
    ...
    return {
      ...
      requiresApproval: action.riskLevel === "high" || action.riskLevel === "sensitive" || action.executionType === "write_action",
      sensitivity: action.riskLevel === "sensitive" ? "sensitive" : "standard",
