...
export function buildExecutionGateStack(params: BuildExecutionGateStackParams): ExecutionGateStack {
  ...
  const aiGate = gate({
    ...
    evidence: {
      ...
      aiRoutingAgentSkillPairs: params.aiRoutingProof?.safeInputContextSummary.agentSkillPairs ?? [],
      aiRoutingAgentRoutingViewHash: params.aiRoutingProof?.safeInputContextSummary.agentRoutingViewHash,
  ...
  const gatewayGate = gate({
    ...
    evidence: {
      ...
      policyPrimaryRuleId: params.connectorPolicy?.primaryRuleId,
      policyPrimaryRuleSource: params.connectorPolicy?.primaryRuleSource,
      ...
      policyMatchedRuleSummaries: params.connectorPolicy?.matchedRuleSummaries ?? [],
      ...
      policyReason: params.connectorPolicy?.reason,
