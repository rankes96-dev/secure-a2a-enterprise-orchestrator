...
function claimsFromPayload(payload: Record<string, unknown>): A2ATokenClaims | undefined {
  ...
  const claims = {
    ...
    actor_issuer: payload.actor_issuer,
  ...
  return {
    ...
    actor_provider: typeof claims.actor_provider === "string" ? claims.actor_provider : undefined,
    actor_issuer: typeof claims.actor_issuer === "string" ? claims.actor_issuer : undefined,
    actor_sub: typeof claims.actor_sub === "string" ? claims.actor_sub : undefined,
