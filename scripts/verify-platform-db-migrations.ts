...
function verifyStatic(): void {
  ...
  for (const phrase of [
    ...
    "state-gated",
    "confirm schema state first",
    "run the expansion step before index DDL when `outcome`/`severity` columns are missing",
    "only when the columns exist and equivalent indexes are absent",
