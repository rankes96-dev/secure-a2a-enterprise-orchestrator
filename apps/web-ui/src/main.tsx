...
import type { AuditViewerFilters, SecurityTimelineEvent, SecurityTimelineFilter } from "./components/types";
...
function App() {
  ...
  const latestActorTokenObserved = Boolean(
    ...
    latestResponse?.connectorRuntime?.authorizationRequirement?.actorSubject ||
    latestResponse?.connectorRuntime?.authorizationRequirement?.actorEmail ||
    latestResponse?.connectorRuntime?.agentResponse?.authorizationRequirement?.actorProvider ||
    latestResponse?.connectorRuntime?.agentResponse?.authorizationRequirement?.actorSubject ||
    latestResponse?.connectorRuntime?.agentResponse?.authorizationRequirement?.actorEmail ||
    latestResponse?.a2aTasks?.some((task) =>
